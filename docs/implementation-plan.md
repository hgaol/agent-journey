...
- [x] explicitly labeled composer-first Simulated Prompt Typing, independent 0.5×–4× Typing Speed, and visual submission
...
- [x] live speed-aware Remaining Replay Time with manual-only fallback
...
- [x] correlated SSE progress for video preparation, frame rendering, encoding, completion, and failure
