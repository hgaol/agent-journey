...
function render(documentValue,rendererTree){
  ...
  const nativeComposer=node("div","stage-native-composer");nativeComposer.append(node("span",null,"❯"),node("i"));stage.append(nativeComposer);const nativeFooter=node("footer","stage-native-footer");const nativeModel=node("span","stage-native-footer-model");nativeModel.append(node("span","stage-native-footer-model-name",documentValue.models?.[0]||"model unknown"));if(documentValue.gitBranch)nativeModel.append(node("span","stage-native-footer-branch"," · "+documentValue.gitBranch));nativeFooter.append(node("span","stage-native-footer-help","← open sidebar · / commands · ? help · tab next Tab"),node("span","stage-native-footer-workspace",documentValue.workspace||"workspace unknown"),nativeModel);stage.append(nativeFooter);
