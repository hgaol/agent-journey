...
function render(documentValue,rendererTree){
  ...
  const nativeComposer=node("div","stage-native-composer");nativeComposer.append(node("span",null,"❯"),node("i"));stage.append(nativeComposer);const nativeFooter=node("footer","stage-native-footer");nativeFooter.append(node("span",null,"← open sidebar · / commands · ? help · tab next tab"),node("span",null,(documentValue.models?.[0]||"model unknown")+" · "+(documentValue.gitBranch||"no branch")));stage.append(nativeFooter);
